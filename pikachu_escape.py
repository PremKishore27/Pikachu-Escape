...
# --------
class PikachuEscapeEnv(gym.Env):
    def __init__(self, grid_size=7, goal_coordinates=(6, 6)) -> None:
        super(PikachuEscapeEnv, self).__init__()
        ...
        pygame.display.set_caption("Pikachu Escape")
        ...
        self.background_image = pygame.transform.scale(self.background_image, (self.cell_size, self.cell_size))
    ...
    def render(self):
        ...
        # Draw the background image for each cell:
...
def create_env(goal_coordinates, hell_state_coordinates):
    ...
    # -----------------------
    env = PikachuEscapeEnv(goal_coordinates=goal_coordinates)
